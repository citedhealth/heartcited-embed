/* heartcited-embed v1.0.0 | MIT | https://widget.heartcited.com */
...
function makeWidgetElement(widgetType, initFn, domainAttrs) {
  ...
  return class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._syncDataAttrs();
      initFn(this, '{"site":"heartcited","name":"HeartCited","domain":"heartcited.com","accent":"#EF4444","attribute":"data-heartcited","apiBase":"https://heartcited.com/api/","searchPath":"/search/","organName":"Heart Health","organSlug":"heart"}');
    }
     ...
     */
    _syncDataAttrs() {
      const attrKey = '{"site":"heartcited","name":"HeartCited","domain":"heartcited.com","accent":"#EF4444","attribute":"data-heartcited","apiBase":"https://heartcited.com/api/","searchPath":"/search/","organName":"Heart Health","organSlug":"heart"}'.attribute.replace("data-", "");
...
(function bootstrap() {
  const config = '{"site":"heartcited","name":"HeartCited","domain":"heartcited.com","accent":"#EF4444","attribute":"data-heartcited","apiBase":"https://heartcited.com/api/","searchPath":"/search/","organName":"Heart Health","organSlug":"heart"}';
